...
def berhu_spatial(predictions, targets, s=0.2, bounded=False, lower_bound=0.5, upper_bound=1.2):
    """
    Reverse huber loss for high-dimensional regression plus a spatial gradient penalty
    :param predictions:
    :param targets:
    :param s:
    :param bounded:
    ...
    # Mask in tensor form
    mask_tensor = T.gt(target, lower_bound) * T.lt(target, upper_bound)
